...
//    cout<< material_queries.begin() <<endl;
    Xapian::Query material_query(Xapian::Query::OP_OR, material_queries.begin(), material_queries.end());

	// Use the material query to filter the main query
//	cout<<" query = "<< query<<endl <<" material_query = "<< material_query <<endl;
